...
try {
		Debug.PushSubsStack("AddColumn (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,593);
if (RapidSub.canDelegate("addcolumn")) { return __ref.runUserSub(false, "b4xtable","addcolumn", __ref, _title, _columntype);}
RemoteObject _c = RemoteObject.declareNull("b4a.example.b4xtable._b4xtablecolumn");
...
Debug.locals.put("ColumnType", _columntype);
 BA.debugLineNum = 593;BA.debugLine="Public Sub AddColumn (Title As String, ColumnType";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 594;BA.debugLine="Dim c As B4XTableColumn";
Debug.JustUpdateDeviceLine();
_c = RemoteObject.createNew ("b4a.example.b4xtable._b4xtablecolumn");Debug.locals.put("c", _c);
 BA.debugLineNum = 595;BA.debugLine="c.Initialize";
Debug.JustUpdateDeviceLine();
_c.runVoidMethod ("Initialize");
 BA.debugLineNum = 596;BA.debugLine="c.Title = Title";
Debug.JustUpdateDeviceLine();
_c.setField ("Title" /*RemoteObject*/ ,_title);
 BA.debugLineNum = 597;BA.debugLine="c.ColumnType = ColumnType";
Debug.JustUpdateDeviceLine();
_c.setField ("ColumnType" /*RemoteObject*/ ,_columntype);
 BA.debugLineNum = 598;BA.debugLine="c.Sortable = ColumnType <> COLUMN_TYPE_VOID";
Debug.JustUpdateDeviceLine();
_c.setField ("Sortable" /*RemoteObject*/ ,BA.ObjectToBoolean(RemoteObject.solveBoolean("!",_columntype,BA.numberCast(double.class, __ref.getField(true,"_column_type_void" /*RemoteObject*/ )))));
 BA.debugLineNum = 599;BA.debugLine="c.Searchable = ColumnType = COLUMN_TYPE_TEXT";
Debug.JustUpdateDeviceLine();
_c.setField ("Searchable" /*RemoteObject*/ ,BA.ObjectToBoolean(RemoteObject.solveBoolean("=",_columntype,BA.numberCast(double.class, __ref.getField(true,"_column_type_text" /*RemoteObject*/ )))));
 BA.debugLineNum = 600;BA.debugLine="c.CellsLayouts.Initialize";
Debug.JustUpdateDeviceLine();
_c.getField(false,"CellsLayouts" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 601;BA.debugLine="c.Formatter = DefaultDataFormatter";
Debug.JustUpdateDeviceLine();
_c.setField ("Formatter" /*RemoteObject*/ ,__ref.getField(false,"_defaultdataformatter" /*RemoteObject*/ ));
 BA.debugLineNum = 602;BA.debugLine="c.Panel = xui.CreatePanel(\"ColumnPanel\")";
Debug.JustUpdateDeviceLine();
_c.setField ("Panel" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("ColumnPanel"))));
 BA.debugLineNum = 603;BA.debugLine="c.Panel.Tag = c";
Debug.JustUpdateDeviceLine();
_c.getField(false,"Panel" /*RemoteObject*/ ).runMethod(false,"setTag",(_c));
 BA.debugLineNum = 604;BA.debugLine="c.Id = Title";
Debug.JustUpdateDeviceLine();
_c.setField ("Id" /*RemoteObject*/ ,_title);
 BA.debugLineNum = 605;BA.debugLine="Columns.Add(c)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_columns" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_c)));
 BA.debugLineNum = 606;BA.debugLine="VisibleColumns.Add(c)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_visiblecolumns" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_c)));
 BA.debugLineNum = 607;BA.debugLine="CreateColumnLayouts(c, mRowsPerPage + 1)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_createcolumnlayouts" /*RemoteObject*/ ,(Object)(_c),(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1)));
 BA.debugLineNum = 608;BA.debugLine="Dim header As B4XView = GetLabelFromColumn(c, 0)";
Debug.JustUpdateDeviceLine();
_header = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_header = __ref.runClassMethod (b4a.example.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("header", _header);Debug.locals.put("header", _header);
 BA.debugLineNum = 609;BA.debugLine="SetTextOrCSBuilderToLabel (header, Title)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_settextorcsbuildertolabel" /*RemoteObject*/ ,(Object)(_header),(Object)((_title)));
 BA.debugLineNum = 610;BA.debugLine="If LayoutLoaded Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_layoutloaded" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 611;BA.debugLine="AddColumnToCLV(c)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_addcolumntoclv" /*RemoteObject*/ ,(Object)(_c));
 };
 BA.debugLineNum = 613;BA.debugLine="Return c";
Debug.JustUpdateDeviceLine();
if (true) return _c;
...
try {
		Debug.PushSubsStack("AddColumnToCLV (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,586);
if (RapidSub.canDelegate("addcolumntoclv")) { return __ref.runUserSub(false, "b4xtable","addcolumntoclv", __ref, _c);}
Debug.locals.put("c", _c);
 BA.debugLineNum = 586;BA.debugLine="Private Sub AddColumnToCLV (c As B4XTableColumn)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 587;BA.debugLine="clvData.Add(c.Panel, c)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Base_Resize (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,142);
if (RapidSub.canDelegate("base_resize")) { return __ref.runUserSub(false, "b4xtable","base_resize", __ref, _width, _height);}
Debug.locals.put("Width", _width);
Debug.locals.put("Height", _height);
 BA.debugLineNum = 142;BA.debugLine="Private Sub Base_Resize (Width As Double, Height A";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 143;BA.debugLine="Refresh2 (False, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"False")),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("BuildLayoutsCache (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,617);
...
Debug.locals.put("Size", _size);
 BA.debugLineNum = 617;BA.debugLine="Public Sub BuildLayoutsCache (Size As Int)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 618;BA.debugLine="For Each c As B4XTableColumn In Columns";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("c", _c);
 BA.debugLineNum = 619;BA.debugLine="CreateColumnLayouts(c, Size + 1)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_createcolumnlayouts" /*RemoteObject*/ ,(Object)(_c),(Object)(RemoteObject.solve(new RemoteObject[] {_size,RemoteObject.createImmutable(1)}, "+",1, 1)));
 }
}Debug.locals.put("c", _c);
;
...
try {
		Debug.PushSubsStack("BuildQuery (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,340);
...
RemoteObject _aargs = null;
int _i = 0;
Debug.locals.put("WithPageLimit", _withpagelimit);
 BA.debugLineNum = 340;BA.debugLine="Public Sub BuildQuery (WithPageLimit As Boolean) A";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 341;BA.debugLine="Dim SortColumn As String";
Debug.JustUpdateDeviceLine();
...
_sb.runVoidMethod ("Initialize");
 BA.debugLineNum = 344;BA.debugLine="sb.Append(\"SELECT rowid\")";
Debug.JustUpdateDeviceLine();
_sb.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("SELECT rowid")));
 BA.debugLineNum = 345;BA.debugLine="For Each c As B4XTableColumn In VisibleColumns";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("c", _c);
 BA.debugLineNum = 346;BA.debugLine="if c.ColumnType = COLUMN_TYPE_VOID Then Continue";
Debug.JustUpdateDeviceLine();
...
if (true) continue;};
 BA.debugLineNum = 347;BA.debugLine="sb.Append(\",\").Append(c.SQLID)";
Debug.JustUpdateDeviceLine();
_sb.runMethod(false,"Append",(Object)(RemoteObject.createImmutable(","))).runVoidMethod ("Append",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ )));
 BA.debugLineNum = 348;BA.debugLine="If c.InternalSortMode <> \"\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_c.getField(true,"InternalSortMode" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
 BA.debugLineNum = 349;BA.debugLine="SortColumn = \" ORDER BY \" & c.SQLID & \" \" & c.I";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 352;BA.debugLine="sb.Append(\" FROM \").Append(SQLTableName).Append(\"";
Debug.JustUpdateDeviceLine();
...
_sb.runMethod(false,"Append",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ ))).runVoidMethod ("Append",(Object)(RemoteObject.createImmutable(" LIKE ? ")));
 BA.debugLineNum = 367;BA.debugLine="If PrefixSearch Then";
Debug.JustUpdateDeviceLine();
...
_args.runVoidMethod ("Add",(Object)((RemoteObject.concat(__ref.getField(true,"_filtertext" /*RemoteObject*/ ),RemoteObject.createImmutable("%")))));
 ...
 BA.debugLineNum = 370;BA.debugLine="args.Add(\"%\" & FilterText & \"%\")";
Debug.JustUpdateDeviceLine();
...
_limit = RemoteObject.solve(new RemoteObject[] {_limit,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("limit", _limit);};
 BA.debugLineNum = 380;BA.debugLine="sb.Append($\" LIMIT ${mFirstRowIndex}, ${limit}\"$";
Debug.JustUpdateDeviceLine();
_sb.runVoidMethod ("Append",(Object)((RemoteObject.concat(RemoteObject.createImmutable(" LIMIT "),b4xtable.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ )))),RemoteObject.createImmutable(", "),b4xtable.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_limit))),RemoteObject.createImmutable("")))));
 ...
 BA.debugLineNum = 383;BA.debugLine="Dim aargs(args.Size) As String";
Debug.JustUpdateDeviceLine();
_aargs = RemoteObject.createNewArray ("String", new int[] {_args.runMethod(true,"getSize").<Integer>get().intValue()}, new Object[]{});Debug.locals.put("aargs", _aargs);
 BA.debugLineNum = 384;BA.debugLine="For i = 0 To args.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step43 = 1;
final int limit43 = RemoteObject.solve(new RemoteObject[] {_args.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
for (;(step43 > 0 && _i <= limit43) || (step43 < 0 && _i >= limit43) ;_i = ((int)(0 + _i + step43))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 385;BA.debugLine="aargs(i) = args.Get(i)";
Debug.JustUpdateDeviceLine();
_aargs.setArrayElement (BA.ObjectToString(_args.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),BA.numberCast(int.class, _i));
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 390;BA.debugLine="Return Array(sb.ToString, aargs, TotalCount)";
Debug.JustUpdateDeviceLine();
if (true) return RemoteObject.createNewArray("Object",new int[] {3},new Object[] {(_sb.runMethod(true,"ToString")),(_aargs),(_totalcount)});
...
try {
		Debug.PushSubsStack("CalculateWidths (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,564);
...
RemoteObject _remainder = RemoteObject.createImmutable(0);
 BA.debugLineNum = 564;BA.debugLine="Private Sub CalculateWidths";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 565;BA.debugLine="Dim wildcardcount As Int";
Debug.JustUpdateDeviceLine();
_wildcardcount = RemoteObject.createImmutable(0);Debug.locals.put("wildcardcount", _wildcardcount);
 BA.debugLineNum = 566;BA.debugLine="Dim TotalExplicitWidth As Int";
Debug.JustUpdateDeviceLine();
_totalexplicitwidth = RemoteObject.createImmutable(0);Debug.locals.put("TotalExplicitWidth", _totalexplicitwidth);
 BA.debugLineNum = 567;BA.debugLine="For Each c As B4XTableColumn In VisibleColumns";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("c", _c);
 BA.debugLineNum = 568;BA.debugLine="If c.Width = 0 Then wildcardcount = wildcardcoun";
Debug.JustUpdateDeviceLine();
...
_c.setField ("ComputedWidth" /*RemoteObject*/ ,_c.getField(true,"Width" /*RemoteObject*/ ));};
 BA.debugLineNum = 569;BA.debugLine="TotalExplicitWidth = TotalExplicitWidth + c.Widt";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 571;BA.debugLine="If wildcardcount = 0 Then Return";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_wildcardcount,BA.numberCast(double.class, 0))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 572;BA.debugLine="Dim WildcardWidth As Int = Max(wildcardcount * Mi";
Debug.JustUpdateDeviceLine();
_wildcardwidth = BA.numberCast(int.class, b4xtable.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_wildcardcount,__ref.getField(true,"_minimumwidth" /*RemoteObject*/ )}, "*",0, 1))),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"),b4xtable.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))),_totalexplicitwidth}, "--",2, 1)))));Debug.locals.put("WildcardWidth", _wildcardwidth);Debug.locals.put("WildcardWidth", _wildcardwidth);
 BA.debugLineNum = 573;BA.debugLine="Dim Width As Int = WildcardWidth / wildcardcount";
Debug.JustUpdateDeviceLine();
_width = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_wildcardwidth,_wildcardcount}, "/",0, 0));Debug.locals.put("Width", _width);Debug.locals.put("Width", _width);
 BA.debugLineNum = 574;BA.debugLine="Dim Remainder As Int = WildcardWidth Mod wildcard";
Debug.JustUpdateDeviceLine();
_remainder = RemoteObject.solve(new RemoteObject[] {_wildcardwidth,_wildcardcount}, "%",0, 1);Debug.locals.put("Remainder", _remainder);Debug.locals.put("Remainder", _remainder);
 BA.debugLineNum = 575;BA.debugLine="For Each c As B4XTableColumn In VisibleColumns";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("c", _c);
 BA.debugLineNum = 576;BA.debugLine="If c.Width = 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c.getField(true,"Width" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 577;BA.debugLine="c.ComputedWidth = Width";
Debug.JustUpdateDeviceLine();
_c.setField ("ComputedWidth" /*RemoteObject*/ ,_width);
 BA.debugLineNum = 578;BA.debugLine="If Remainder > 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_remainder,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 579;BA.debugLine="Remainder = Remainder - 1";
Debug.JustUpdateDeviceLine();
_remainder = RemoteObject.solve(new RemoteObject[] {_remainder,RemoteObject.createImmutable(1)}, "-",1, 1);Debug.locals.put("Remainder", _remainder);
 BA.debugLineNum = 580;BA.debugLine="c.ComputedWidth = c.ComputedWidth + 1";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Cell_Click (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,735);
if (RapidSub.canDelegate("cell_click")) { return __ref.runUserSub(false, "b4xtable","cell_click", __ref);}
 BA.debugLineNum = 735;BA.debugLine="Private Sub Cell_Click";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 736;BA.debugLine="CellClicked(Sender, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_cellclicked" /*void*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), b4xtable.__c.runMethod(false,"Sender",__ref.getField(false, "ba"))),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("Cell_LongClick (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,739);
if (RapidSub.canDelegate("cell_longclick")) { return __ref.runUserSub(false, "b4xtable","cell_longclick", __ref);}
 BA.debugLineNum = 739;BA.debugLine="Private Sub Cell_LongClick";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 740;BA.debugLine="CellClicked(Sender, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_cellclicked" /*void*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), b4xtable.__c.runMethod(false,"Sender",__ref.getField(false, "ba"))),(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("CellClicked (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,780);
...
public ResumableSub_CellClicked(b4a.example.b4xtable parent,RemoteObject __ref,RemoteObject _pnl,RemoteObject _longclicked) {
this.parent = parent;
this.__ref = __ref;
this._pnl = _pnl;
...
RemoteObject _column = RemoteObject.declareNull("b4a.example.b4xtable._b4xtablecolumn");
...
{ BA.debugLineNum = 799;BA.debugLine="Else If VisibleRowIds.Size > 0 Then";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_headerclicked" /*RemoteObject*/ ,(Object)(_column));
 if (true) break;
;
...
try {
		Debug.PushSubsStack("CheckAndRemoveColumnThatWasAddedToIncorrectParent (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,282);
...
Debug.locals.put("IsFrozen", _isfrozen);
 BA.debugLineNum = 282;BA.debugLine="Private Sub CheckAndRemoveColumnThatWasAddedToInco";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 283;BA.debugLine="If (c.Panel.Parent = mBase) <> IsFrozen Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",RemoteObject.createImmutable((RemoteObject.solveBoolean("=",_c.getField(false,"Panel" /*RemoteObject*/ ).runMethod(false,"getParent"),__ref.getField(false,"_mbase" /*RemoteObject*/ )))),_isfrozen)) { 
 BA.debugLineNum = 284;BA.debugLine="If IsFrozen Then";
Debug.JustUpdateDeviceLine();
if (_isfrozen.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 285;BA.debugLine="RemoveColumnFromCLV(c)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_removecolumnfromclv" /*RemoteObject*/ ,(Object)(_c));
 }else {
 BA.debugLineNum = 287;BA.debugLine="c.Panel.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
...
b4xtable._sql1 = RemoteObject.createNew ("anywheresoftware.b4a.sql.SQL");__ref.setField("_sql1",b4xtable._sql1);
...
b4xtable._defaultformatter = RemoteObject.createNew ("b4a.example.b4xformatter");__ref.setField("_defaultformatter",b4xtable._defaultformatter);
b4xtable._defaultdataformatter = RemoteObject.createNew ("b4a.example.b4xformatter");__ref.setField("_defaultdataformatter",b4xtable._defaultdataformatter);
...
b4xtable._clvdata = RemoteObject.createNew ("b4a.example3.customlistview");__ref.setField("_clvdata",b4xtable._clvdata);
 //BA.debugLineNum = 34;BA.debugLine="Public pnlHeader As B4XView";
b4xtable._pnlheader = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_pnlheader",b4xtable._pnlheader);
 //BA.debugLineNum = 35;BA.debugLine="Public RowHeight, HeadersHeight As Int";
...
b4xtable._headersheight = RemoteObject.createImmutable(0);__ref.setField("_headersheight",b4xtable._headersheight);
 //BA.debugLineNum = 36;BA.debugLine="Public AllowSmallRowHeightModifications As Boolea";
...
b4xtable._gridcolor = RemoteObject.createImmutable(0);__ref.setField("_gridcolor",b4xtable._gridcolor);
 //BA.debugLineNum = 42;BA.debugLine="Public HighlightSearchResults As Boolean = True";
b4xtable._highlightsearchresults = b4xtable.__c.getField(true,"True");__ref.setField("_highlightsearchresults",b4xtable._highlightsearchresults);
 //BA.debugLineNum = 43;BA.debugLine="Public HeaderFont, LabelsFont As B4XFont";
...
b4xtable._labelsfont = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont");__ref.setField("_labelsfont",b4xtable._labelsfont);
 //BA.debugLineNum = 44;BA.debugLine="Public lblFirst As B4XView";
b4xtable._lblfirst = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_lblfirst",b4xtable._lblfirst);
 //BA.debugLineNum = 45;BA.debugLine="Public lblBack As B4XView";
b4xtable._lblback = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_lblback",b4xtable._lblback);
 //BA.debugLineNum = 46;BA.debugLine="Public lblNumber As B4XView";
b4xtable._lblnumber = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_lblnumber",b4xtable._lblnumber);
 //BA.debugLineNum = 47;BA.debugLine="Public lblNext As B4XView";
b4xtable._lblnext = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_lblnext",b4xtable._lblnext);
 //BA.debugLineNum = 48;BA.debugLine="Public lblLast As B4XView";
b4xtable._lbllast = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_lbllast",b4xtable._lbllast);
 //BA.debugLineNum = 49;BA.debugLine="Public lblFromTo As B4XView";
...
b4xtable._lblsort = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_lblsort",b4xtable._lblsort);
 //BA.debugLineNum = 54;BA.debugLine="Public SearchField As B4XFloatTextField";
b4xtable._searchfield = RemoteObject.createNew ("b4a.example.b4xfloattextfield");__ref.setField("_searchfield",b4xtable._searchfield);
 //BA.debugLineNum = 55;BA.debugLine="Private FilterText As String";
b4xtable._filtertext = RemoteObject.createImmutable("");__ref.setField("_filtertext",b4xtable._filtertext);
 //BA.debugLineNum = 56;BA.debugLine="Public SleepBeforeSearch As Int = 300";
b4xtable._sleepbeforesearch = BA.numberCast(int.class, 300);__ref.setField("_sleepbeforesearch",b4xtable._sleepbeforesearch);
 //BA.debugLineNum = 57;BA.debugLine="Private SearchIndex As Int";
b4xtable._searchindex = RemoteObject.createImmutable(0);__ref.setField("_searchindex",b4xtable._searchindex);
 //BA.debugLineNum = 58;BA.debugLine="Public ArrowsEnabledColor, ArrowsDisabledColor As";
...
b4xtable._arrowsdisabledcolor = RemoteObject.createImmutable(0);__ref.setField("_arrowsdisabledcolor",b4xtable._arrowsdisabledcolor);
 //BA.debugLineNum = 59;BA.debugLine="Public VisibleRowIds As List";
...
b4xtable._numberoffrozencolumns = RemoteObject.createImmutable(0);__ref.setField("_numberoffrozencolumns",b4xtable._numberoffrozencolumns);
 //BA.debugLineNum = 74;BA.debugLine="Private LastCellClickEvent As Long";
b4xtable._lastcellclickevent = RemoteObject.createImmutable(0L);__ref.setField("_lastcellclickevent",b4xtable._lastcellclickevent);
 //BA.debugLineNum = 78;BA.debugLine="Public SearchVisible As Boolean";
...
try {
		Debug.PushSubsStack("Clear (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,147);
...
public ResumableSub_Clear(b4a.example.b4xtable parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
java.util.LinkedHashMap<String, Object> rsLocals = new java.util.LinkedHashMap<String, Object>();
RemoteObject __ref;
b4a.example.b4xtable parent;
RemoteObject _oldsql = RemoteObject.declareNull("anywheresoftware.b4a.sql.SQL");
RemoteObject _c = RemoteObject.declareNull("b4a.example.b4xtable._b4xtablecolumn");
RemoteObject group4;
int index4;
int groupLen4;
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 148;BA.debugLine="SQLIndex = SQLIndex + 1";
Debug.JustUpdateDeviceLine();
__ref.setField ("_sqlindex" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_sqlindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 149;BA.debugLine="Dim OldSQL As SQL = sql1";
Debug.JustUpdateDeviceLine();
_oldsql = __ref.getField(false,"_sql1" /*RemoteObject*/ );Debug.locals.put("OldSQL", _oldsql);Debug.locals.put("OldSQL", _oldsql);
 BA.debugLineNum = 150;BA.debugLine="Dim sql1 As SQL";
Debug.JustUpdateDeviceLine();
parent._sql1 = RemoteObject.createNew ("anywheresoftware.b4a.sql.SQL");__ref.setField("_sql1",parent._sql1);
 BA.debugLineNum = 151;BA.debugLine="For Each c As B4XTableColumn In Columns";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 152;BA.debugLine="If c.Panel.IsInitialized And c.Panel.Parent.IsIn";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 153;BA.debugLine="c.Panel.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
_c.getField(false,"Panel" /*RemoteObject*/ ).runVoidMethod ("RemoveViewFromParent");
 if (true) break;
...
Debug.locals.put("c", _c);
;
 BA.debugLineNum = 156;BA.debugLine="VisibleColumns.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_visiblecolumns" /*RemoteObject*/ ).runVoidMethod ("Clear");
 BA.debugLineNum = 157;BA.debugLine="Columns.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_columns" /*RemoteObject*/ ).runVoidMethod ("Clear");
 BA.debugLineNum = 158;BA.debugLine="SQLTableName = \"data\"";
Debug.JustUpdateDeviceLine();
__ref.setField ("_sqltablename" /*RemoteObject*/ ,BA.ObjectToString("data"));
 BA.debugLineNum = 159;BA.debugLine="VisibleColumns.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_visiblecolumns" /*RemoteObject*/ ).runVoidMethod ("Clear");
 BA.debugLineNum = 160;BA.debugLine="If clvData.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 12;
 BA.debugLineNum = 161;BA.debugLine="clvData.Clear";
Debug.JustUpdateDeviceLine();
...
this.state = 13;
;
 BA.debugLineNum = 163;BA.debugLine="mFirstRowIndex = 0";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mfirstrowindex" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 164;BA.debugLine="ClearNavigationState";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_clearnavigationstate" /*RemoteObject*/ );
...
this.state = 16;
;
 BA.debugLineNum = 167;BA.debugLine="If OldSQL.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 168;BA.debugLine="Log(\"closing old db.\")";
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","95570581",RemoteObject.createImmutable("closing old db."),0);
 BA.debugLineNum = 169;BA.debugLine="OldSQL.Close";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ClearDataView (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,403);
if (RapidSub.canDelegate("cleardataview")) { return __ref.runUserSub(false, "b4xtable","cleardataview", __ref);}
 BA.debugLineNum = 403;BA.debugLine="Public Sub ClearDataView";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 404;BA.debugLine="SQLTableName = \"data\"";
Debug.JustUpdateDeviceLine();
__ref.setField ("_sqltablename" /*RemoteObject*/ ,BA.ObjectToString("data"));
 BA.debugLineNum = 405;BA.debugLine="mFirstRowIndex = 0";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mfirstrowindex" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 406;BA.debugLine="CountAll = sql1.ExecQuerySingleResult(\"SELECT cou";
Debug.JustUpdateDeviceLine();
__ref.setField ("_countall" /*RemoteObject*/ ,BA.numberCast(int.class, __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(true,"ExecQuerySingleResult",(Object)(RemoteObject.createImmutable("SELECT count(*) FROM data")))));
 BA.debugLineNum = 407;BA.debugLine="UpdateData (True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("ClearNavigationState (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,174);
if (RapidSub.canDelegate("clearnavigationstate")) { return __ref.runUserSub(false, "b4xtable","clearnavigationstate", __ref);}
 BA.debugLineNum = 174;BA.debugLine="Private Sub ClearNavigationState";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 175;BA.debugLine="If lblNext.IsInitialized = False Then Return";
Debug.JustUpdateDeviceLine();
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 176;BA.debugLine="SetPageLabelState(lblNext, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblnext" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 177;BA.debugLine="SetPageLabelState(lblLast, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 178;BA.debugLine="SetPageLabelState(lblBack, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblback" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 179;BA.debugLine="SetPageLabelState(lblFirst, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblfirst" /*RemoteObject*/ )),(Object)(b4xtable.__c.getField(true,"False")));
 BA.debugLineNum = 180;BA.debugLine="lblFromTo.Text = \"\"";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblfromto" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 181;BA.debugLine="lblNumber.Text = \"\"";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblnumber" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(""));
...
try {
		Debug.PushSubsStack("ColumnToSQLType (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,708);
...
try {
		Debug.PushSubsStack("CreateCellViews (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,713);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setmousetransparent" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _lbl.getObject()));
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("AddView",(Object)((_xlbl.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("CreateColumnLayouts (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,623);
...
Debug.locals.put("c", _c);
Debug.locals.put("Size", _size);
 BA.debugLineNum = 623;BA.debugLine="Private Sub CreateColumnLayouts (c As B4XTableColu";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 624;BA.debugLine="For i = c.CellsLayouts.Size To Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step1 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 625;BA.debugLine="Dim p As B4XView = CreateCellViews";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = __ref.runClassMethod (b4a.example.b4xtable.class, "_createcellviews" /*RemoteObject*/ );Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 626;BA.debugLine="Dim lbl As B4XView = p.GetView(c.LabelIndex)";
Debug.JustUpdateDeviceLine();
...
if (RemoteObject.solveBoolean("=",RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(2)}, "%",0, 1),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 638;BA.debugLine="clr = EvenRowColor";
Debug.JustUpdateDeviceLine();
_clr = __ref.getField(true,"_evenrowcolor" /*RemoteObject*/ );Debug.locals.put("clr", _clr);
 }else {
 BA.debugLineNum = 640;BA.debugLine="clr = OddRowColor";
Debug.JustUpdateDeviceLine();
_clr = __ref.getField(true,"_oddrowcolor" /*RemoteObject*/ );Debug.locals.put("clr", _clr);
 };
 };
 BA.debugLineNum = 643;BA.debugLine="lbl.Font = fnt";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(false,"setFont",_fnt);
 BA.debugLineNum = 644;BA.debugLine="p.SetColorAndBorder(clr, 1dip, GridColor, 0)";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetColorAndBorder",(Object)(_clr),(Object)(b4xtable.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1)))),(Object)(__ref.getField(true,"_gridcolor" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 645;BA.debugLine="lbl.TextColor = tclr";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(true,"setTextColor",_tclr);
 BA.debugLineNum = 646;BA.debugLine="lbl.SetTextAlignment(\"CENTER\", \"CENTER\")";
Debug.JustUpdateDeviceLine();
_lbl.runVoidMethod ("SetTextAlignment",(Object)(BA.ObjectToString("CENTER")),(Object)(RemoteObject.createImmutable("CENTER")));
 BA.debugLineNum = 647;BA.debugLine="p.Tag = i";
Debug.JustUpdateDeviceLine();
_p.runMethod(false,"setTag",RemoteObject.createImmutable((_i)));
 BA.debugLineNum = 648;BA.debugLine="c.Panel.AddView(p, 0, 0, 0, 0)";
Debug.JustUpdateDeviceLine();
_c.getField(false,"Panel" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((_p.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("CreateDataView (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,394);
...
Debug.locals.put("WhereClause", _whereclause);
 BA.debugLineNum = 394;BA.debugLine="Public Sub CreateDataView (WhereClause As String)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 395;BA.debugLine="sql1.ExecNonQuery(\"DROP VIEW IF EXISTS TempView\")";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.createImmutable("DROP VIEW IF EXISTS TempView")));
 BA.debugLineNum = 396;BA.debugLine="sql1.ExecNonQuery(\"CREATE VIEW TempView AS SELECT";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("CREATE VIEW TempView AS SELECT *, rowid FROM data WHERE "),_whereclause)));
 BA.debugLineNum = 397;BA.debugLine="CountAll = sql1.ExecQuerySingleResult(\"SELECT cou";
Debug.JustUpdateDeviceLine();
__ref.setField ("_countall" /*RemoteObject*/ ,BA.numberCast(int.class, __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(true,"ExecQuerySingleResult",(Object)(RemoteObject.createImmutable("SELECT count(*) FROM TempView")))));
 BA.debugLineNum = 398;BA.debugLine="mFirstRowIndex = 0";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mfirstrowindex" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 399;BA.debugLine="SQLTableName = \"TempView\"";
Debug.JustUpdateDeviceLine();
__ref.setField ("_sqltablename" /*RemoteObject*/ ,BA.ObjectToString("TempView"));
 BA.debugLineNum = 400;BA.debugLine="UpdateData (False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("CreateTable (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,692);
...
Debug.JustUpdateDeviceLine();
_sb.runVoidMethod ("Append",(Object)(RemoteObject.concat(_column.getField(true,"SQLID" /*RemoteObject*/ ),RemoteObject.createImmutable(" "),__ref.runClassMethod (b4a.example.b4xtable.class, "_columntosqltype" /*RemoteObject*/ ,(Object)(_column)),RemoteObject.createImmutable(","))));
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,105);
...
public ResumableSub_DesignerCreateView(b4a.example.b4xtable parent,RemoteObject __ref,RemoteObject _base,RemoteObject _lbl,RemoteObject _props) {
this.parent = parent;
this.__ref = __ref;
this._base = _base;
this._lbl = _lbl;
...
__ref.getField(false,"_mbase" /*RemoteObject*/ ).setObject (_base);
 BA.debugLineNum = 107;BA.debugLine="LastBaseHeight = mBase.Height";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lastbaseheight" /*RemoteObject*/ ,__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"));
 BA.debugLineNum = 108;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
Debug.JustUpdateDeviceLine();
__ref.setField ("_tag" /*RemoteObject*/ ,__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(false,"getTag"));
 BA.debugLineNum = 108;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(false,"setTag",__ref);
 BA.debugLineNum = 109;BA.debugLine="LayoutLoaded = False";
Debug.JustUpdateDeviceLine();
__ref.setField ("_layoutloaded" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 BA.debugLineNum = 110;BA.debugLine="EvenRowColor = xui.PaintOrColorToColor(Props.Get(";
Debug.JustUpdateDeviceLine();
__ref.setField ("_evenrowcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("EvenRowColor")))))));
 BA.debugLineNum = 111;BA.debugLine="OddRowColor = xui.PaintOrColorToColor(Props.Get(\"";
Debug.JustUpdateDeviceLine();
__ref.setField ("_oddrowcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("OddRowColor")))))));
 BA.debugLineNum = 112;BA.debugLine="HeaderTextColor = xui.PaintOrColorToColor(Props.G";
Debug.JustUpdateDeviceLine();
__ref.setField ("_headertextcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("HeaderTextColor")))))));
 BA.debugLineNum = 113;BA.debugLine="TextColor = xui.PaintOrColorToColor(Props.Get(\"Te";
Debug.JustUpdateDeviceLine();
__ref.setField ("_textcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("TextColor")))))));
 BA.debugLineNum = 114;BA.debugLine="HeaderColor = xui.PaintOrColorToColor(Props.Get(\"";
Debug.JustUpdateDeviceLine();
__ref.setField ("_headercolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("HeaderColor")))))));
 BA.debugLineNum = 115;BA.debugLine="GridColor = xui.PaintOrColorToColor(Props.Get(\"Gr";
Debug.JustUpdateDeviceLine();
__ref.setField ("_gridcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("GridColor")))))));
 BA.debugLineNum = 116;BA.debugLine="SelectionColor = xui.PaintOrColorToColor(Props.Ge";
Debug.JustUpdateDeviceLine();
__ref.setField ("_selectioncolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("SelectionColor")))))));
 BA.debugLineNum = 117;BA.debugLine="HighlightTextColor = xui.PaintOrColorToColor(Prop";
Debug.JustUpdateDeviceLine();
__ref.setField ("_highlighttextcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("HighlightTextColor"))),(Object)(RemoteObject.createImmutable((0xffff0000)))))));
 BA.debugLineNum = 118;BA.debugLine="SearchVisible = Props.GetDefault(\"SearchVisible\",";
Debug.JustUpdateDeviceLine();
__ref.setField ("_searchvisible" /*RemoteObject*/ ,BA.ObjectToBoolean(_props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("SearchVisible"))),(Object)((parent.__c.getField(true,"True"))))));
 BA.debugLineNum = 119;BA.debugLine="If Bit.And(SelectionColor, 0xff000000) = 0 Then S";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//if
this.state = 6;
if (RemoteObject.solveBoolean("=",parent.__c.getField(false,"Bit").runMethod(true,"And",(Object)(__ref.getField(true,"_selectioncolor" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 0xff000000))),BA.numberCast(double.class, 0))) { 
this.state = 3;
;}if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 121;BA.debugLine="mBase.LoadLayout(\"B4XTable\")";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout",(Object)(RemoteObject.createImmutable("B4XTable")),__ref.getField(false, "ba"));
 BA.debugLineNum = 122;BA.debugLine="SearchField.mBase.Visible = False";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"setVisible",parent.__c.getField(true,"False"));
 BA.debugLineNum = 123;BA.debugLine="SearchField.LargeLabelTextSize = 14";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).setField ("_largelabeltextsize" /*RemoteObject*/ ,BA.numberCast(float.class, 14));
 BA.debugLineNum = 124;BA.debugLine="SearchField.SmallLabelTextSize = 8";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).setField ("_smalllabeltextsize" /*RemoteObject*/ ,BA.numberCast(float.class, 8));
 BA.debugLineNum = 125;BA.debugLine="SearchField.Update";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xfloattextfield.class, "_update" /*RemoteObject*/ );
 BA.debugLineNum = 127;BA.debugLine="Dim jo As JavaObject = SearchField.TextField";
Debug.JustUpdateDeviceLine();
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_searchfield" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);
 BA.debugLineNum = 128;BA.debugLine="jo.RunMethod(\"setImeOptions\", Array(Bit.Or(6, 0x1";
Debug.JustUpdateDeviceLine();
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setImeOptions")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(parent.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, 6)),(Object)(BA.numberCast(int.class, 0x10000000))))})));
 BA.debugLineNum = 133;BA.debugLine="SetMouseTransparent(lblSort)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setmousetransparent" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblsort" /*RemoteObject*/ )));
 BA.debugLineNum = 134;BA.debugLine="clvData.AsView.SetColorAndBorder(0, 0, 0, 0)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runVoidMethod ("SetColorAndBorder",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 135;BA.debugLine="clvData.sv.SetColorAndBorder(0, 0, 0, 0)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).getField(false,"_sv").runVoidMethod ("SetColorAndBorder",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 136;BA.debugLine="lblNumber.TextColor = ArrowsEnabledColor";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblnumber" /*RemoteObject*/ ).runMethod(true,"setTextColor",__ref.getField(true,"_arrowsenabledcolor" /*RemoteObject*/ ));
 BA.debugLineNum = 137;BA.debugLine="LayoutLoaded = True";
Debug.JustUpdateDeviceLine();
__ref.setField ("_layoutloaded" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 138;BA.debugLine="ClearNavigationState";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_clearnavigationstate" /*RemoteObject*/ );
 BA.debugLineNum = 139;BA.debugLine="Refresh2 (True, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(parent.__c.getField(true,"True")),(Object)(parent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("GetColumn (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,542);
...
Debug.locals.put("ColumnId", _columnid);
 BA.debugLineNum = 542;BA.debugLine="Public Sub GetColumn (ColumnId As String) As B4XTa";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 543;BA.debugLine="For Each c As B4XTableColumn In Columns";
Debug.JustUpdateDeviceLine();
{
final RemoteObject group1 = __ref.getField(false,"_columns" /*RemoteObject*/ );
final int groupLen1 = group1.runMethod(true,"getSize").<Integer>get()
...
_c = (group1.runMethod(false,"Get",index1));Debug.locals.put("c", _c);
Debug.locals.put("c", _c);
 BA.debugLineNum = 544;BA.debugLine="If c.Id = ColumnId Then Return c";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 546;BA.debugLine="Return c";
Debug.JustUpdateDeviceLine();
if (true) return _c;
...
try {
		Debug.PushSubsStack("getCurrentPage (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,899);
...
try {
		Debug.PushSubsStack("getFirstRowIndex (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,889);
...
try {
		Debug.PushSubsStack("GetLabelFromColumn (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,559);
...
Debug.locals.put("Index", _index);
 BA.debugLineNum = 559;BA.debugLine="Private Sub GetLabelFromColumn (c As B4XTableColum";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 560;BA.debugLine="Dim p As B4XView = c.CellsLayouts.Get(Index)";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _c.getField(false,"CellsLayouts" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(_index)));Debug.locals.put("p", _p);
 BA.debugLineNum = 561;BA.debugLine="Return p.GetView(c.LabelIndex)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("GetRow (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,862);
...
_rs = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery2",(Object)(BA.ObjectToString("SELECT * FROM data WHERE rowid = ?")),(Object)(RemoteObject.createNewArray("String",new int[] {1},new Object[] {BA.NumberToString(_rowid)}))));Debug.locals.put("rs", _rs);
...
try {
		Debug.PushSubsStack("getRowsPerPage (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,894);
...
try {
		Debug.PushSubsStack("getSize (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,961);
if (RapidSub.canDelegate("getsize")) { return __ref.runUserSub(false, "b4xtable","getsize", __ref);}
 BA.debugLineNum = 961;BA.debugLine="Public Sub getSize As Int";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 962;BA.debugLine="Return CountAll";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("HeaderClicked (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,828);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_updatesorticon" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ImplUpdateDataFromQuery (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,416);
...
public ResumableSub_ImplUpdateDataFromQuery(b4a.example.b4xtable parent,RemoteObject __ref,RemoteObject _query,RemoteObject _args,RemoteObject _totalcount,RemoteObject _dontsleep) {
this.parent = parent;
this.__ref = __ref;
this._query = _query;
this._args = _args;
...
Debug.locals.put("DontSleep", _dontsleep);
 BA.debugLineNum = 417;BA.debugLine="SQLIndex = SQLIndex + 1";
Debug.JustUpdateDeviceLine();
__ref.setField ("_sqlindex" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_sqlindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 418;BA.debugLine="If mRowsPerPage = 0 Then Return";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 10;
 BA.debugLineNum = 422;BA.debugLine="Sleep(40)";
Debug.JustUpdateDeviceLine();
...
;
 if (true) break;
;
 BA.debugLineNum = 424;BA.debugLine="If MyIndex <> SQLIndex Then";
Debug.JustUpdateDeviceLine();
...
this.state = 14;
;
 BA.debugLineNum = 427;BA.debugLine="VisibleRowIds.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_visiblerowids" /*RemoteObject*/ ).runVoidMethod ("Clear");
 BA.debugLineNum = 429;BA.debugLine="Dim rs As ResultSet = sql1.ExecQuery2(Query, Args";
Debug.JustUpdateDeviceLine();
_rs = RemoteObject.createNew ("anywheresoftware.b4a.sql.SQL.ResultSetWrapper");
_rs = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery2",(Object)(_query),(Object)((_args))));Debug.locals.put("rs", _rs);
 BA.debugLineNum = 430;BA.debugLine="Dim success As Boolean = True";
Debug.JustUpdateDeviceLine();
_success = parent.__c.getField(true,"True");Debug.locals.put("success", _success);Debug.locals.put("success", _success);
 BA.debugLineNum = 434;BA.debugLine="If success Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 17;
 BA.debugLineNum = 435;BA.debugLine="Dim RowNumber As Int = 1";
Debug.JustUpdateDeviceLine();
_rownumber = BA.numberCast(int.class, 1);Debug.locals.put("RowNumber", _rownumber);Debug.locals.put("RowNumber", _rownumber);
 BA.debugLineNum = 436;BA.debugLine="Do While RowNumber <= mRowsPerPage And rs.NextRo";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 20;
 BA.debugLineNum = 437;BA.debugLine="VisibleRowIds.Add(rs.GetLong(\"rowid\"))";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_visiblerowids" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_rs.runMethod(true,"GetLong",(Object)(RemoteObject.createImmutable("rowid"))))));
 BA.debugLineNum = 438;BA.debugLine="For Each c As B4XTableColumn In VisibleColumns";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 23;
 BA.debugLineNum = 439;BA.debugLine="Dim lbl As B4XView = GetLabelFromColumn(c, Row";
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_lbl = __ref.runClassMethod (b4a.example.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(_rownumber));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 440;BA.debugLine="Select c.ColumnType";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 30;
 BA.debugLineNum = 442;BA.debugLine="SetTextToCell(rs.GetString(c.SQLID), lbl, c.";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_settexttocell" /*RemoteObject*/ ,(Object)(_rs.runMethod(true,"GetString",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ )))),(Object)(_lbl),(Object)(_c.getField(true,"Searchable" /*RemoteObject*/ )));
 if (true) break;

case 27:
//C
this.state = 30;
 BA.debugLineNum = 444;BA.debugLine="c.Formatter.FormatLabel(rs.GetDouble(c.SQLID";
Debug.JustUpdateDeviceLine();
_c.getField(false,"Formatter" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xformatter.class, "_formatlabel" /*RemoteObject*/ ,(Object)(_rs.runMethod(true,"GetDouble",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ )))),(Object)(_lbl));
 if (true) break;

case 29:
//C
this.state = 30;
 BA.debugLineNum = 446;BA.debugLine="lbl.Text = DateTime.Date(rs.GetLong(c.SQLID)";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(parent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_rs.runMethod(true,"GetLong",(Object)(_c.getField(true,"SQLID" /*RemoteObject*/ )))))));
 if (true) break;
...
Debug.locals.put("c", _c);
;
 BA.debugLineNum = 449;BA.debugLine="RowNumber = RowNumber + 1";
Debug.JustUpdateDeviceLine();
...
this.state = 33;
;
 BA.debugLineNum = 451;BA.debugLine="Dim AreThereMoreResults As Boolean = RowNumber =";
Debug.JustUpdateDeviceLine();
_aretheremoreresults = BA.ObjectToBoolean(RemoteObject.solveBoolean("=",_rownumber,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1))) && RemoteObject.solveBoolean(".",_rs.runMethod(true,"NextRow")));Debug.locals.put("AreThereMoreResults", _aretheremoreresults);Debug.locals.put("AreThereMoreResults", _aretheremoreresults);
 BA.debugLineNum = 452;BA.debugLine="rs.Close";
Debug.JustUpdateDeviceLine();
_rs.runVoidMethod ("Close");
 BA.debugLineNum = 453;BA.debugLine="For i = RowNumber To mRowsPerPage";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 36;
 BA.debugLineNum = 454;BA.debugLine="For Each c As B4XTableColumn In VisibleColumns";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 71;
 BA.debugLineNum = 458;BA.debugLine="GetLabelFromColumn(c, i).Text = \"\"";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_getlabelfromcolumn" /*RemoteObject*/ ,(Object)(_c),(Object)(BA.numberCast(int.class, _i))).runMethod(true,"setText",BA.ObjectToCharSequence(""));
 if (true) break;
if (true) break;
...
Debug.locals.put("c", _c);
;
 BA.debugLineNum = 461;BA.debugLine="VisibleRowIds.Add(0)";
Debug.JustUpdateDeviceLine();
...
Debug.locals.put("i", _i);
;
 BA.debugLineNum = 463;BA.debugLine="mLastRowIndex = mFirstRowIndex - 2 + RowNumber";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mlastrowindex" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),RemoteObject.createImmutable(2),_rownumber}, "-+",2, 1));
 BA.debugLineNum = 464;BA.debugLine="SetPageLabelState(lblLast, TotalCount >= 0)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("g",_totalcount,BA.numberCast(double.class, 0)))));
 BA.debugLineNum = 465;BA.debugLine="If TotalCount >= 0 Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 58;
 BA.debugLineNum = 466;BA.debugLine="lblFromTo.Text = $\"${DefaultFormatter.Format(mF";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblfromto" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence((RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(false,"_defaultformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1))))))),RemoteObject.createImmutable(" "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_stringto" /*RemoteObject*/ )))),RemoteObject.createImmutable(" "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(false,"_defaultformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlastrowindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1))))))),RemoteObject.createImmutable(" "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_stringoutof" /*RemoteObject*/ )))),RemoteObject.createImmutable(" "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(false,"_defaultformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _totalcount)))))),RemoteObject.createImmutable("")))));
 BA.debugLineNum = 467;BA.debugLine="SetPageLabelState(lblNext, mLastRowIndex < Tota";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblnext" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean("<",__ref.getField(true,"_mlastrowindex" /*RemoteObject*/ ),BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_totalcount,RemoteObject.createImmutable(1)}, "-",1, 1))))));
 BA.debugLineNum = 468;BA.debugLine="SetPageLabelState(lblLast, lblNext.Tag)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(__ref.getField(false,"_lblnext" /*RemoteObject*/ ).runMethod(false,"getTag"))));
 if (true) break;

case 45:
//C
this.state = 46;
 BA.debugLineNum = 470;BA.debugLine="If mLastRowIndex = -1 Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 57;
 BA.debugLineNum = 471;BA.debugLine="lblFromTo.Text = StringNoMatches";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblfromto" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(__ref.getField(true,"_stringnomatches" /*RemoteObject*/ )));
 if (true) break;

case 50:
//C
this.state = 51;
 BA.debugLineNum = 473;BA.debugLine="lblFromTo.Text = $\"${DefaultFormatter.Format(m";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblfromto" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence((RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(false,"_defaultformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1))))))),RemoteObject.createImmutable(" "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_stringto" /*RemoteObject*/ )))),RemoteObject.createImmutable(" "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(false,"_defaultformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlastrowindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1))))))),RemoteObject.createImmutable("")))));
 BA.debugLineNum = 474;BA.debugLine="If AreThereMoreResults Then lblFromTo.Text = l";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 56;
__ref.getField(false,"_lblfromto" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(__ref.getField(false,"_lblfromto" /*RemoteObject*/ ).runMethod(true,"getText"),RemoteObject.createImmutable(" "),__ref.getField(true,"_stringmoreavailable" /*RemoteObject*/ ))));
if (true) break;
...
this.state = 58;
;
 BA.debugLineNum = 476;BA.debugLine="SetPageLabelState(lblNext, AreThereMoreResults)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblnext" /*RemoteObject*/ )),(Object)(_aretheremoreresults));
 BA.debugLineNum = 477;BA.debugLine="SetPageLabelState(lblLast, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbllast" /*RemoteObject*/ )),(Object)(parent.__c.getField(true,"False")));
 if (true) break;
...
this.state = 61;
;
 BA.debugLineNum = 479;BA.debugLine="SetPageLabelState(lblBack, mFirstRowIndex > 0)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblback" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(RemoteObject.solveBoolean(">",__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),BA.numberCast(double.class, 0)))));
 BA.debugLineNum = 480;BA.debugLine="SetPageLabelState(lblFirst, lblBack.Tag)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setpagelabelstate" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblfirst" /*RemoteObject*/ )),(Object)(BA.ObjectToBoolean(__ref.getField(false,"_lblback" /*RemoteObject*/ ).runMethod(false,"getTag"))));
 BA.debugLineNum = 481;BA.debugLine="mCurrentPage = Ceil(mFirstRowIndex / mRowsPerPag";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mcurrentpage" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {parent.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "/",0, 0))),RemoteObject.createImmutable(1)}, "+",1, 0)));
 BA.debugLineNum = 482;BA.debugLine="lblNumber.Text = NumberFormat(mCurrentPage, 0, 0";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblnumber" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(parent.__c.runMethod(true,"NumberFormat",(Object)(BA.numberCast(double.class, __ref.getField(true,"_mcurrentpage" /*RemoteObject*/ ))),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)))));
 BA.debugLineNum = 483;BA.debugLine="rs.Close";
Debug.JustUpdateDeviceLine();
_rs.runVoidMethod ("Close");
 BA.debugLineNum = 484;BA.debugLine="mCurrentCount = TotalCount";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","96553670",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
;
 BA.debugLineNum = 488;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_DataUp";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 64;
 BA.debugLineNum = 489;BA.debugLine="CallSub(mCallBack, mEventName & \"_DataUpdated\")";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Initialize (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,82);
...
Debug.locals.put("EventName", _eventname);
 BA.debugLineNum = 82;BA.debugLine="Public Sub Initialize (Callback As Object, EventNa";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 83;BA.debugLine="mEventName = EventName";
Debug.JustUpdateDeviceLine();
__ref.setField ("_meventname" /*RemoteObject*/ ,_eventname);
 BA.debugLineNum = 84;BA.debugLine="mCallBack = Callback";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mcallback" /*RemoteObject*/ ,_callback);
 BA.debugLineNum = 85;BA.debugLine="Columns.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_columns" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 86;BA.debugLine="DefaultFormatter.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_defaultformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xformatter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 87;BA.debugLine="DefaultDataFormatter.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_defaultdataformatter" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xformatter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 88;BA.debugLine="VisibleColumns.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_visiblecolumns" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 89;BA.debugLine="HeaderFont = xui.CreateDefaultBoldFont(15)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_headerfont" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreateDefaultBoldFont",(Object)(BA.numberCast(float.class, 15))));
 BA.debugLineNum = 90;BA.debugLine="LabelsFont = xui.CreateDefaultFont(15)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_labelsfont" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreateDefaultFont",(Object)(BA.numberCast(float.class, 15))));
 BA.debugLineNum = 91;BA.debugLine="ArrowsDisabledColor = 0xFFBBBBBB";
Debug.JustUpdateDeviceLine();
__ref.setField ("_arrowsdisabledcolor" /*RemoteObject*/ ,BA.numberCast(int.class, 0xffbbbbbb));
 BA.debugLineNum = 92;BA.debugLine="ArrowsEnabledColor = xui.Color_Black";
Debug.JustUpdateDeviceLine();
__ref.setField ("_arrowsenabledcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Black"));
 BA.debugLineNum = 93;BA.debugLine="VisibleRowIds.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_visiblerowids" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 94;BA.debugLine="MinimumWidth = 140dip";
Debug.JustUpdateDeviceLine();
__ref.setField ("_minimumwidth" /*RemoteObject*/ ,b4xtable.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 140))));
 BA.debugLineNum = 95;BA.debugLine="RowHeight = 40dip";
Debug.JustUpdateDeviceLine();
__ref.setField ("_rowheight" /*RemoteObject*/ ,b4xtable.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 40))));
 BA.debugLineNum = 96;BA.debugLine="HeadersHeight = 40dip";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("lbl_Click (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,725);
if (RapidSub.canDelegate("lbl_click")) { return __ref.runUserSub(false, "b4xtable","lbl_click", __ref);}
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_lbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), b4xtable.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 727;BA.debugLine="CellClicked(lbl.Parent, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_cellclicked" /*void*/ ,(Object)(_lbl.runMethod(false,"getParent")),(Object)(b4xtable.__c.getField(true,"False")));
...
public static RemoteObject  _lbl_longclick(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("lbl_LongClick (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,730);
if (RapidSub.canDelegate("lbl_longclick")) { return __ref.runUserSub(false, "b4xtable","lbl_longclick", __ref);}
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_cellclicked" /*void*/ ,(Object)(_lbl.runMethod(false,"getParent")),(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("lblBack_Click (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,912);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "-",1, 1)));
...
try {
		Debug.PushSubsStack("lblFirst_Click (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,907);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("lblLast_Click (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,917);
...
try {
		Debug.PushSubsStack("lblNext_Click (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,922);
if (RapidSub.canDelegate("lblnext_click")) { return __ref.runUserSub(false, "b4xtable","lblnext_click", __ref);}
 BA.debugLineNum = 922;BA.debugLine="Private Sub lblNext_Click";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 923;BA.debugLine="If lblNext.Tag = False Then Return";
Debug.JustUpdateDeviceLine();
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 924;BA.debugLine="setFirstRowIndex (mFirstRowIndex + mRowsPerPage)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mfirstrowindex" /*RemoteObject*/ ),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "+",1, 1)));
...
try {
		Debug.PushSubsStack("Refresh (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,185);
if (RapidSub.canDelegate("refresh")) { return __ref.runUserSub(false, "b4xtable","refresh", __ref);}
 BA.debugLineNum = 185;BA.debugLine="Public Sub Refresh";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 186;BA.debugLine="Refresh2(True, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")),(Object)(b4xtable.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("Refresh2 (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,194);
...
Debug.locals.put("DontSleep", _dontsleep);
 BA.debugLineNum = 194;BA.debugLine="Private Sub Refresh2 (RefreshData As Boolean, Dont";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 195;BA.debugLine="If LayoutLoaded = False Or VisibleColumns.Size =";
Debug.JustUpdateDeviceLine();
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 196;BA.debugLine="Dim PrevRowsPerPage As Int = mRowsPerPage";
Debug.JustUpdateDeviceLine();
_prevrowsperpage = __ref.getField(true,"_mrowsperpage" /*RemoteObject*/ );Debug.locals.put("PrevRowsPerPage", _prevrowsperpage);Debug.locals.put("PrevRowsPerPage", _prevrowsperpage);
 BA.debugLineNum = 197;BA.debugLine="If xui.IsB4A And LastBaseHeight <> mBase.Height T";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4A")) && RemoteObject.solveBoolean("!",__ref.getField(true,"_lastbaseheight" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")))) { 
 BA.debugLineNum = 198;BA.debugLine="clvData.AsView.Height = clvData.AsView.Height -";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"setHeight",RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getHeight"),(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_lastbaseheight" /*RemoteObject*/ ),__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")}, "-",1, 1))}, "-",1, 1));
 BA.debugLineNum = 199;BA.debugLine="clvData.Base_Resize(clvData.AsView.Width, clvDat";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runVoidMethod ("_base_resize",(Object)(BA.numberCast(double.class, __ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getHeight"))));
 BA.debugLineNum = 200;BA.debugLine="LastBaseHeight = mBase.Height";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lastbaseheight" /*RemoteObject*/ ,__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"));
 };
 BA.debugLineNum = 202;BA.debugLine="Dim TotalHeight As Int = clvData.AsView.Height -";
Debug.JustUpdateDeviceLine();
_totalheight = RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getHeight"),__ref.getField(true,"_headersheight" /*RemoteObject*/ )}, "-",1, 1);Debug.locals.put("TotalHeight", _totalheight);Debug.locals.put("TotalHeight", _totalheight);
 BA.debugLineNum = 203;BA.debugLine="If xui.IsB4J Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4J").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 204;BA.debugLine="TotalHeight = TotalHeight - 20";
Debug.JustUpdateDeviceLine();
_totalheight = RemoteObject.solve(new RemoteObject[] {_totalheight,RemoteObject.createImmutable(20)}, "-",1, 1);Debug.locals.put("TotalHeight", _totalheight);
 ...
 BA.debugLineNum = 206;BA.debugLine="If AllowSmallRowHeightModifications Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_allowsmallrowheightmodifications" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 207;BA.debugLine="mRowsPerPage = Max(0, Round(TotalHeight/ RowHeig";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mrowsperpage" /*RemoteObject*/ ,BA.numberCast(int.class, b4xtable.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, b4xtable.__c.runMethod(true,"Round",(Object)(RemoteObject.solve(new RemoteObject[] {_totalheight,__ref.getField(true,"_rowheight" /*RemoteObject*/ )}, "/",0, 0))))))));
 ...
 BA.debugLineNum = 209;BA.debugLine="mRowsPerPage = Max(0, Floor(TotalHeight / RowHei";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mrowsperpage" /*RemoteObject*/ ,BA.numberCast(int.class, b4xtable.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(b4xtable.__c.runMethod(true,"Floor",(Object)(RemoteObject.solve(new RemoteObject[] {_totalheight,__ref.getField(true,"_rowheight" /*RemoteObject*/ )}, "/",0, 0)))))));
 ...
 BA.debugLineNum = 211;BA.debugLine="If MaximumRowsPerPage > 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",__ref.getField(true,"_maximumrowsperpage" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 212;BA.debugLine="mRowsPerPage = Min(MaximumRowsPerPage, mRowsPerP";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mrowsperpage" /*RemoteObject*/ ,BA.numberCast(int.class, b4xtable.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, __ref.getField(true,"_maximumrowsperpage" /*RemoteObject*/ ))),(Object)(BA.numberCast(double.class, __ref.getField(true,"_mrowsperpage" /*RemoteObject*/ ))))));
 BA.debugLineNum = 213;BA.debugLine="TotalHeight = Min(TotalHeight, MaximumRowsPerPag";
Debug.JustUpdateDeviceLine();
_totalheight = BA.numberCast(int.class, b4xtable.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, _totalheight)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_maximumrowsperpage" /*RemoteObject*/ ),__ref.getField(true,"_rowheight" /*RemoteObject*/ )}, "*",0, 1)))));Debug.locals.put("TotalHeight", _totalheight);
 ...
 BA.debugLineNum = 215;BA.debugLine="If PrevRowsPerPage <> mRowsPerPage Then RefreshDa";
Debug.JustUpdateDeviceLine();
...
_refreshdata = b4xtable.__c.getField(true,"True");Debug.locals.put("RefreshData", _refreshdata);};
 BA.debugLineNum = 216;BA.debugLine="CalculateWidths";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_calculatewidths" /*RemoteObject*/ );
 BA.debugLineNum = 217;BA.debugLine="Dim ColumnIndex As Int";
Debug.JustUpdateDeviceLine();
_columnindex = RemoteObject.createImmutable(0);Debug.locals.put("ColumnIndex", _columnindex);
 BA.debugLineNum = 219;BA.debugLine="For Each c As B4XTableColumn In VisibleColumns";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("c", _c);
 BA.debugLineNum = 220;BA.debugLine="Dim IsFrozen As Boolean = ColumnIndex < NumberOf";
Debug.JustUpdateDeviceLine();
_isfrozen = BA.ObjectToBoolean(RemoteObject.solveBoolean("<",_columnindex,BA.numberCast(double.class, __ref.getField(true,"_numberoffrozencolumns" /*RemoteObject*/ ))));Debug.locals.put("IsFrozen", _isfrozen);Debug.locals.put("IsFrozen", _isfrozen);
 BA.debugLineNum = 221;BA.debugLine="If c.Panel.Parent.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (_c.getField(false,"Panel" /*RemoteObject*/ ).runMethod(false,"getParent").runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 222;BA.debugLine="CheckAndRemoveColumnThatWasAddedToIncorrectPare";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_checkandremovecolumnthatwasaddedtoincorrectparent" /*RemoteObject*/ ,(Object)(_c),(Object)(_isfrozen));
 };
 BA.debugLineNum = 224;BA.debugLine="If c.Panel.Parent.IsInitialized = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c.getField(false,"Panel" /*RemoteObject*/ ).runMethod(false,"getParent").runMethod(true,"IsInitialized"),b4xtable.__c.getField(true,"False"))) { 
 BA.debugLineNum = 225;BA.debugLine="c.Panel.Width = c.ComputedWidth";
Debug.JustUpdateDeviceLine();
_c.getField(false,"Panel" /*RemoteObject*/ ).runMethod(true,"setWidth",_c.getField(true,"ComputedWidth" /*RemoteObject*/ ));
 BA.debugLineNum = 226;BA.debugLine="If IsFrozen Then";
Debug.JustUpdateDeviceLine();
if (_isfrozen.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 227;BA.debugLine="mBase.AddView(c.Panel, 0, 0, 0, 0)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((_c.getField(false,"Panel" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 }else {
 BA.debugLineNum = 229;BA.debugLine="AddColumnToCLV (c)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_addcolumntoclv" /*RemoteObject*/ ,(Object)(_c));
 };
 };
 BA.debugLineNum = 233;BA.debugLine="CreateColumnLayouts(c, mRowsPerPage + 1)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_createcolumnlayouts" /*RemoteObject*/ ,(Object)(_c),(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1)));
 BA.debugLineNum = 234;BA.debugLine="ResizeColumnImpl(c, TotalHeight)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_resizecolumnimpl" /*RemoteObject*/ ,(Object)(_c),(Object)(_totalheight));
 BA.debugLineNum = 235;BA.debugLine="ColumnIndex = ColumnIndex + 1";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 237;BA.debugLine="If RefreshData Then UpdateData (DontSleep)";
Debug.JustUpdateDeviceLine();
if (_refreshdata.<Boolean>get().booleanValue()) { 
__ref.runClassMethod (b4a.example.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(_dontsleep));};
 BA.debugLineNum = 238;BA.debugLine="Dim FreezedWidth As Int";
Debug.JustUpdateDeviceLine();
_freezedwidth = RemoteObject.createImmutable(0);Debug.locals.put("FreezedWidth", _freezedwidth);
 BA.debugLineNum = 239;BA.debugLine="For i = 0 To NumberOfFrozenColumns - 1";
Debug.JustUpdateDeviceLine();
{
final int step43 = 1;
...
for (;(step43 > 0 && _i <= limit43) || (step43 < 0 && _i >= limit43) ;_i = ((int)(0 + _i + step43))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 240;BA.debugLine="Dim c As B4XTableColumn = VisibleColumns.Get(i)";
Debug.JustUpdateDeviceLine();
_c = (__ref.getField(false,"_visiblecolumns" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("c", _c);Debug.locals.put("c", _c);
 BA.debugLineNum = 244;BA.debugLine="Dim offset As Float = 0";
Debug.JustUpdateDeviceLine();
_offset = BA.numberCast(float.class, 0);Debug.locals.put("offset", _offset);Debug.locals.put("offset", _offset);
 BA.debugLineNum = 246;BA.debugLine="c.Panel.SetLayoutAnimated(0, offset + FreezedWid";
Debug.JustUpdateDeviceLine();
_c.getField(false,"Panel" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_offset,_freezedwidth}, "+",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getTop"),_offset}, "+",1, 0))),(Object)(_c.getField(true,"ComputedWidth" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getHeight")));
 BA.debugLineNum = 248;BA.debugLine="FreezedWidth = FreezedWidth + c.ComputedWidth";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 250;BA.debugLine="clvData.AsView.Left = FreezedWidth";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"setLeft",_freezedwidth);
 BA.debugLineNum = 251;BA.debugLine="If Round(clvData.AsView.Width) <> Round(mBase.Wid";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",b4xtable.__c.runMethod(true,"Round",(Object)(BA.numberCast(double.class, __ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getWidth")))),b4xtable.__c.runMethod(true,"Round",(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"),_freezedwidth}, "-",1, 1)))))) { 
 BA.debugLineNum = 252;BA.debugLine="clvData.AsView.Width = mBase.Width - FreezedWidt";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"setWidth",RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"),_freezedwidth}, "-",1, 1));
 BA.debugLineNum = 253;BA.debugLine="If xui.IsB4A Then clvData.Base_Resize(clvData.As";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4A").<Boolean>get().booleanValue()) { 
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runVoidMethod ("_base_resize",(Object)(BA.numberCast(double.class, __ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_asview").runMethod(true,"getHeight"))));};
 };
 BA.debugLineNum = 255;BA.debugLine="ResizeAndReorderCLVItems";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_resizeandreorderclvitems" /*RemoteObject*/ );
 BA.debugLineNum = 256;BA.debugLine="UpdateSearchFieldVisibility";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_updatesearchfieldvisibility" /*RemoteObject*/ );
 BA.debugLineNum = 257;BA.debugLine="UpdateSortIcon";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_updatesorticon" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("RefreshNow (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,190);
if (RapidSub.canDelegate("refreshnow")) { return __ref.runUserSub(false, "b4xtable","refreshnow", __ref);}
 BA.debugLineNum = 190;BA.debugLine="Public Sub RefreshNow";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 191;BA.debugLine="Refresh2(True, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_refresh2" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")),(Object)(b4xtable.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("RemoveColumnFromCLV (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,292);
if (RapidSub.canDelegate("removecolumnfromclv")) { return __ref.runUserSub(false, "b4xtable","removecolumnfromclv", __ref, _c);}
int _i = 0;
Debug.locals.put("c", _c);
 BA.debugLineNum = 292;BA.debugLine="Private Sub RemoveColumnFromCLV (c As B4XTableColu";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 293;BA.debugLine="For i = 0 To clvData.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step1 = 1;
...
for (;(step1 > 0 && _i <= limit1) || (step1 < 0 && _i >= limit1) ;_i = ((int)(0 + _i + step1))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 294;BA.debugLine="If clvData.GetValue(i) = c Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_getvalue",(Object)(BA.numberCast(int.class, _i))),(_c))) { 
 BA.debugLineNum = 295;BA.debugLine="clvData.RemoveAt(i)";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 299;BA.debugLine="c.Panel.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
_c.getField(false,"Panel" /*RemoteObject*/ ).runVoidMethod ("RemoveViewFromParent");
...
try {
		Debug.PushSubsStack("ResizeAndReorderCLVItems (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,260);
...
RemoteObject _clvindex = RemoteObject.createImmutable(0);
 BA.debugLineNum = 260;BA.debugLine="Private Sub ResizeAndReorderCLVItems";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 261;BA.debugLine="Dim i As Int = NumberOfFrozenColumns";
Debug.JustUpdateDeviceLine();
_i = __ref.getField(true,"_numberoffrozencolumns" /*RemoteObject*/ );Debug.locals.put("i", _i);Debug.locals.put("i", _i);
 BA.debugLineNum = 262;BA.debugLine="Do While i < VisibleColumns.Size";
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("<",_i,BA.numberCast(double.class, __ref.getField(false,"_visiblecolumns" /*RemoteObject*/ ).runMethod(true,"getSize")))) {
 BA.debugLineNum = 263;BA.debugLine="Dim c As B4XTableColumn = VisibleColumns.Get(i)";
Debug.JustUpdateDeviceLine();
_c = (__ref.getField(false,"_visiblecolumns" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(_i)));Debug.locals.put("c", _c);Debug.locals.put("c", _c);
 BA.debugLineNum = 264;BA.debugLine="Dim CLVIndex As Int = i - NumberOfFrozenColumns";
Debug.JustUpdateDeviceLine();
_clvindex = RemoteObject.solve(new RemoteObject[] {_i,__ref.getField(true,"_numberoffrozencolumns" /*RemoteObject*/ )}, "-",1, 1);Debug.locals.put("CLVIndex", _clvindex);Debug.locals.put("CLVIndex", _clvindex);
 BA.debugLineNum = 265;BA.debugLine="If c <> clvData.GetValue(CLVIndex) Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_c,(__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runMethod(false,"_getvalue",(Object)(_clvindex))))) { 
 BA.debugLineNum = 266;BA.debugLine="RemoveColumnFromCLV(c)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_removecolumnfromclv" /*RemoteObject*/ ,(Object)(_c));
 BA.debugLineNum = 267;BA.debugLine="clvData.InsertAt(CLVIndex, c.Panel, c)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runVoidMethod ("_insertat",(Object)(_clvindex),(Object)(_c.getField(false,"Panel" /*RemoteObject*/ )),(Object)((_c)));
 ...
 BA.debugLineNum = 269;BA.debugLine="clvData.ResizeItem(CLVIndex, c.ComputedWidth)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_clvdata" /*RemoteObject*/ ).runVoidMethod ("_resizeitem",(Object)(_clvindex),(Object)(_c.getField(true,"ComputedWidth" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 271;BA.debugLine="i = i + 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("i", _i);
 }
;
...
try {
		Debug.PushSubsStack("ResizeColumnImpl (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,302);
...
Debug.locals.put("TotalHeight", _totalheight);
 BA.debugLineNum = 302;BA.debugLine="Private Sub ResizeColumnImpl (c As B4XTableColumn,";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 303;BA.debugLine="c.Panel.Width = c.ComputedWidth";
Debug.JustUpdateDeviceLine();
_c.getField(false,"Panel" /*RemoteObject*/ ).runMethod(true,"setWidth",_c.getField(true,"ComputedWidth" /*RemoteObject*/ ));
 BA.debugLineNum = 305;BA.debugLine="Dim Height As Float = TotalHeight / mRowsPerPage";
Debug.JustUpdateDeviceLine();
_height = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_totalheight,__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "/",0, 0));Debug.locals.put("Height", _height);Debug.locals.put("Height", _height);
 BA.debugLineNum = 306;BA.debugLine="If AllowSmallRowHeightModifications = False Then";
Debug.JustUpdateDeviceLine();
...
_height = BA.numberCast(float.class, __ref.getField(true,"_rowheight" /*RemoteObject*/ ));Debug.locals.put("Height", _height);};
 BA.debugLineNum = 307;BA.debugLine="Dim TopInt, HeightInt As Int";
Debug.JustUpdateDeviceLine();
...
_heightint = RemoteObject.createImmutable(0);Debug.locals.put("HeightInt", _heightint);
 BA.debugLineNum = 308;BA.debugLine="For i = 0 To c.CellsLayouts.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step5 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 309;BA.debugLine="Dim p As B4XView = c.CellsLayouts.Get(i)";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _c.getField(false,"CellsLayouts" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("p", _p);
 BA.debugLineNum = 310;BA.debugLine="If i < mRowsPerPage + 1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",RemoteObject.createImmutable(_i),BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1)))) { 
 BA.debugLineNum = 311;BA.debugLine="Dim HeightInt As Int = Round(Height * i + Heade";
Debug.JustUpdateDeviceLine();
_heightint = BA.numberCast(int.class, b4xtable.__c.runMethod(true,"Round",(Object)(RemoteObject.solve(new RemoteObject[] {_height,RemoteObject.createImmutable(_i),__ref.getField(true,"_headersheight" /*RemoteObject*/ ),_topint}, "*+-",2, 0))));Debug.locals.put("HeightInt", _heightint);Debug.locals.put("HeightInt", _heightint);
 BA.debugLineNum = 312;BA.debugLine="If i = 0 Then HeightInt = HeadersHeight";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",RemoteObject.createImmutable(_i),BA.numberCast(double.class, 0))) { 
_heightint = __ref.getField(true,"_headersheight" /*RemoteObject*/ );Debug.locals.put("HeightInt", _heightint);};
 BA.debugLineNum = 313;BA.debugLine="p.SetLayoutAnimated(0, 0, TopInt, c.ComputedWid";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_topint),(Object)(_c.getField(true,"ComputedWidth" /*RemoteObject*/ )),(Object)(_heightint));
 BA.debugLineNum = 314;BA.debugLine="p.Visible = True";
Debug.JustUpdateDeviceLine();
_p.runMethod(true,"setVisible",b4xtable.__c.getField(true,"True"));
 BA.debugLineNum = 315;BA.debugLine="If c.DisableAutoResizeLayout = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c.getField(true,"DisableAutoResizeLayout" /*RemoteObject*/ ),b4xtable.__c.getField(true,"False"))) { 
 BA.debugLineNum = 316;BA.debugLine="Dim lbl As B4XView = p.GetView(0)";
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_lbl = _p.runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 317;BA.debugLine="lbl.SetLayoutAnimated(0, 0, 0, p.Width, p.Heig";
Debug.JustUpdateDeviceLine();
_lbl.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_p.runMethod(true,"getWidth")),(Object)(_p.runMethod(true,"getHeight")));
 };
 BA.debugLineNum = 324;BA.debugLine="TopInt = TopInt + HeightInt";
Debug.JustUpdateDeviceLine();
_topint = RemoteObject.solve(new RemoteObject[] {_topint,_heightint}, "+",1, 1);Debug.locals.put("TopInt", _topint);
 }else {
 BA.debugLineNum = 326;BA.debugLine="p.Visible = False";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,946);
...
public ResumableSub_SearchField_TextChanged(b4a.example.b4xtable parent,RemoteObject __ref,RemoteObject _old,RemoteObject _new) {
this.parent = parent;
this.__ref = __ref;
this._old = _old;
this._new = _new;
...
Debug.locals.put("New", _new);
 BA.debugLineNum = 947;BA.debugLine="SearchIndex = SearchIndex + 1";
Debug.JustUpdateDeviceLine();
__ref.setField ("_searchindex" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_searchindex" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 948;BA.debugLine="Dim MyIndex As Int = SearchIndex";
Debug.JustUpdateDeviceLine();
_myindex = __ref.getField(true,"_searchindex" /*RemoteObject*/ );Debug.locals.put("MyIndex", _myindex);Debug.locals.put("MyIndex", _myindex);
 BA.debugLineNum = 949;BA.debugLine="Sleep(SleepBeforeSearch)";
Debug.JustUpdateDeviceLine();
...
this.state = 1;
;
 BA.debugLineNum = 950;BA.debugLine="If MyIndex <> SearchIndex Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
this.state = 5;
;
 BA.debugLineNum = 953;BA.debugLine="Dim term As String = New.ToLowerCase";
Debug.JustUpdateDeviceLine();
_term = _new.runMethod(true,"toLowerCase");Debug.locals.put("term", _term);Debug.locals.put("term", _term);
 BA.debugLineNum = 954;BA.debugLine="If term = FilterText Then Return";
Debug.JustUpdateDeviceLine();
if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 955;BA.debugLine="FilterText = term";
Debug.JustUpdateDeviceLine();
__ref.setField ("_filtertext" /*RemoteObject*/ ,_term);
 BA.debugLineNum = 956;BA.debugLine="mFirstRowIndex = 0";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mfirstrowindex" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 957;BA.debugLine="UpdateData (False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(parent.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setCurrentPage (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,903);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_setfirstrowindex" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_p,RemoteObject.createImmutable(1)}, "-",1, 1)),__ref.getField(true,"_mrowsperpage" /*RemoteObject*/ )}, "*",0, 1)));
...
try {
		Debug.PushSubsStack("SetData (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,654);
...
public ResumableSub_SetData(b4a.example.b4xtable parent,RemoteObject __ref,RemoteObject _data) {
this.parent = parent;
this.__ref = __ref;
this._data = _data;
}
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString(":memory:")),(Object)(parent.__c.getField(true,"True")));
 BA.debugLineNum = 661;BA.debugLine="CreateTable";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_createtable" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_refreshnow" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("setFirstRowIndex (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,883);
...
try {
		Debug.PushSubsStack("SetMouseTransparent (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,757);
...
try {
		Debug.PushSubsStack("SetPageLabelState (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,549);
...
Debug.locals.put("enabled", _enabled);
 BA.debugLineNum = 549;BA.debugLine="Private Sub SetPageLabelState (lbl As B4XView, ena";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 550;BA.debugLine="If lbl.Tag = enabled Then Return";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_lbl.runMethod(false,"getTag"),(_enabled))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 551;BA.debugLine="lbl.Tag = enabled";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(false,"setTag",(_enabled));
 BA.debugLineNum = 552;BA.debugLine="If enabled Then";
Debug.JustUpdateDeviceLine();
if (_enabled.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 553;BA.debugLine="lbl.TextColor = ArrowsEnabledColor";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(true,"setTextColor",__ref.getField(true,"_arrowsenabledcolor" /*RemoteObject*/ ));
 }else {
 BA.debugLineNum = 555;BA.debugLine="lbl.TextColor = ArrowsDisabledColor";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,764);
...
try {
		Debug.PushSubsStack("SetTextToCell (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,493);
...
Debug.locals.put("Searchable", _searchable);
 BA.debugLineNum = 493;BA.debugLine="Private Sub SetTextToCell (Text As String, lbl As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 494;BA.debugLine="If Searchable = False or HighlightSearchResults =";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_searchable,b4xtable.__c.getField(true,"False")) || RemoteObject.solveBoolean("=",__ref.getField(true,"_highlightsearchresults" /*RemoteObject*/ ),b4xtable.__c.getField(true,"False"))) { 
 BA.debugLineNum = 495;BA.debugLine="lbl.Text = Text";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(_text));
 }else {
 BA.debugLineNum = 503;BA.debugLine="If FilterText = \"\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_filtertext" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
 BA.debugLineNum = 504;BA.debugLine="lbl.Text = Text";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(_text));
 }else {
 BA.debugLineNum = 506;BA.debugLine="Dim x As Int = Text.ToLowerCase.IndexOf(FilterT";
Debug.JustUpdateDeviceLine();
_x = _text.runMethod(true,"toLowerCase").runMethod(true,"indexOf",(Object)(__ref.getField(true,"_filtertext" /*RemoteObject*/ )));Debug.locals.put("x", _x);Debug.locals.put("x", _x);
 BA.debugLineNum = 507;BA.debugLine="If x = -1 Or (PrefixSearch And x > 0) Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_x,BA.numberCast(double.class, -(double) (0 + 1))) || RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(".",__ref.getField(true,"_prefixsearch" /*RemoteObject*/ )) && RemoteObject.solveBoolean(">",_x,BA.numberCast(double.class, 0)))))) { 
 BA.debugLineNum = 508;BA.debugLine="lbl.Text = Text";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(_text));
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 513;BA.debugLine="Dim cs As CSBuilder";
Debug.JustUpdateDeviceLine();
_cs = RemoteObject.createNew ("anywheresoftware.b4a.objects.CSBuilder");Debug.locals.put("cs", _cs);
 BA.debugLineNum = 514;BA.debugLine="cs.Initialize.Append(Text.SubString2(0, x)).Col";
Debug.JustUpdateDeviceLine();
_cs.runMethod(false,"Initialize").runMethod(false,"Append",(Object)(BA.ObjectToCharSequence(_text.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(_x))))).runMethod(false,"Color",(Object)(__ref.getField(true,"_highlighttextcolor" /*RemoteObject*/ ))).runMethod(false,"Append",(Object)(BA.ObjectToCharSequence(_text.runMethod(true,"substring",(Object)(_x),(Object)(RemoteObject.solve(new RemoteObject[] {_x,__ref.getField(true,"_filtertext" /*RemoteObject*/ ).runMethod(true,"length")}, "+",1, 1)))))).runVoidMethod ("Pop");
 BA.debugLineNum = 515;BA.debugLine="cs.Append(Text.SubString(x + FilterText.Length)";
Debug.JustUpdateDeviceLine();
_cs.runVoidMethod ("Append",(Object)(BA.ObjectToCharSequence(_text.runMethod(true,"substring",(Object)(RemoteObject.solve(new RemoteObject[] {_x,__ref.getField(true,"_filtertext" /*RemoteObject*/ ).runMethod(true,"length")}, "+",1, 1))))));
 BA.debugLineNum = 517;BA.debugLine="lbl.Text = cs";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(_cs.getObject()));
 };
 };
...
try {
		Debug.PushSubsStack("UpdateData (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,331);
...
Debug.locals.put("DontSleep", _dontsleep);
 BA.debugLineNum = 331;BA.debugLine="Private Sub UpdateData (DontSleep As Boolean)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 332;BA.debugLine="If sql1.IsInitialized = False Then Return";
Debug.JustUpdateDeviceLine();
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 333;BA.debugLine="Dim o() As Object = BuildQuery(True)";
Debug.JustUpdateDeviceLine();
_o = __ref.runClassMethod (b4a.example.b4xtable.class, "_buildquery" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")));Debug.locals.put("o", _o);Debug.locals.put("o", _o);
 BA.debugLineNum = 335;BA.debugLine="ImplUpdateDataFromQuery (o(0), o(1), o(2), DontSl";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_implupdatedatafromquery" /*void*/ ,(Object)(BA.ObjectToString(_o.getArrayElement(false,BA.numberCast(int.class, 0)))),(Object)(_o.getArrayElement(false,BA.numberCast(int.class, 1))),(Object)(BA.numberCast(int.class, _o.getArrayElement(false,BA.numberCast(int.class, 2)))),(Object)(_dontsleep));
...
public static RemoteObject  _updatesearchfieldvisibility(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("UpdateSearchFieldVisibility (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,275);
if (RapidSub.canDelegate("updatesearchfieldvisibility")) { return __ref.runUserSub(false, "b4xtable","updatesearchfieldvisibility", __ref);}
 BA.debugLineNum = 275;BA.debugLine="Private Sub UpdateSearchFieldVisibility";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 279;BA.debugLine="SearchField.mBase.Visible = SearchVisible And Cou";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("UpdateSortIcon (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,843);
if (RapidSub.canDelegate("updatesorticon")) { return __ref.runUserSub(false, "b4xtable","updatesorticon", __ref);}
RemoteObject _col = RemoteObject.declareNull("b4a.example.b4xtable._b4xtablecolumn");
...
Debug.JustUpdateDeviceLine();
_col.getField(false,"Panel" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((__ref.getField(false,"_lblsort" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(BA.numberCast(int.class, 0)));
 };
 BA.debugLineNum = 850;BA.debugLine="lblSort.Top = 0";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"setTop",BA.numberCast(int.class, 0));
 BA.debugLineNum = 851;BA.debugLine="lblSort.Height = HeadersHeight";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"setHeight",__ref.getField(true,"_headersheight" /*RemoteObject*/ ));
 BA.debugLineNum = 852;BA.debugLine="lblSort.Left = col.Panel.Width - lblSort.Width";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"setLeft",RemoteObject.solve(new RemoteObject[] {_col.getField(false,"Panel" /*RemoteObject*/ ).runMethod(true,"getWidth"),__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"getWidth")}, "-",1, 1));
...
__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(b4xtable.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf0de)))));}
else {
__ref.getField(false,"_lblsort" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(b4xtable.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf0dd)))));};
...
try {
		Debug.PushSubsStack("UpdateTableCounters (b4xtable) ","b4xtable",9,__ref.getField(false, "ba"),__ref,411);
if (RapidSub.canDelegate("updatetablecounters")) { return __ref.runUserSub(false, "b4xtable","updatetablecounters", __ref);}
 BA.debugLineNum = 411;BA.debugLine="Public Sub UpdateTableCounters";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 412;BA.debugLine="CountAll = sql1.ExecQuerySingleResult(\"SELECT cou";
Debug.JustUpdateDeviceLine();
__ref.setField ("_countall" /*RemoteObject*/ ,BA.numberCast(int.class, __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(true,"ExecQuerySingleResult",(Object)(RemoteObject.createImmutable("SELECT count(*) FROM data")))));
 BA.debugLineNum = 413;BA.debugLine="UpdateData (True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xtable.class, "_updatedata" /*RemoteObject*/ ,(Object)(b4xtable.__c.getField(true,"True")));
