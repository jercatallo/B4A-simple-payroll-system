...
try {
		Debug.PushSubsStack("btnMonth_Click (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,151);
...
try {
		Debug.PushSubsStack("btnYear_Click (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,145);
...
try {
		Debug.PushSubsStack("DaysPaneFg_Touch (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,158);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("DrawBox (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("DrawDays (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("getDate (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("GetPanel (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,163);
...
try {
		Debug.PushSubsStack("HandleMouse (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("Hide (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,140);
...
try {
		Debug.PushSubsStack("Initialize (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,34);
...
try {
		Debug.PushSubsStack("SelectDay (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,110);
...
try {
		Debug.PushSubsStack("setDate (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("SetYearsButtonState (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("Show (b4xdatetemplate) ","b4xdatetemplate",16,__ref.getField(false, "ba"),__ref,167);
...
_days = parent._dateutils.runMethod(false,"_getdaysnames",__ref.getField(false, "ba"));Debug.locals.put("days", _days);Debug.locals.put("days", _days);
