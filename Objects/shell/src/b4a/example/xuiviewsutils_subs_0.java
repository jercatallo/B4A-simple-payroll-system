...
try {
		Debug.PushSubsStack("AddStubToCLVIfNeeded (xuiviewsutils) ","xuiviewsutils",34,_ba,xuiviewsutils.mostCurrent,34);
...
try {
		Debug.PushSubsStack("CreateB4XImageView (xuiviewsutils) ","xuiviewsutils",34,_ba,xuiviewsutils.mostCurrent,85);
...
try {
		Debug.PushSubsStack("CreateLabel (xuiviewsutils) ","xuiviewsutils",34,_ba,xuiviewsutils.mostCurrent,78);
...
try {
		Debug.PushSubsStack("Initialize (xuiviewsutils) ","xuiviewsutils",34,_ba,xuiviewsutils.mostCurrent,10);
...
try {
		Debug.PushSubsStack("PerformHapticFeedback (xuiviewsutils) ","xuiviewsutils",34,_ba,xuiviewsutils.mostCurrent,21);
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _view.getObject());Debug.locals.put("jo", _jo);
...
try {
		Debug.PushSubsStack("SetBitmapAndFill (xuiviewsutils) ","xuiviewsutils",34,_ba,xuiviewsutils.mostCurrent,65);
...
_iiv = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ImageViewWrapper"), _imageview.getObject());Debug.locals.put("iiv", _iiv);
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (xuiviewsutils) ","xuiviewsutils",34,_ba,xuiviewsutils.mostCurrent,50);
