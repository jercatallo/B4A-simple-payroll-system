...
try {
		Debug.PushSubsStack("ConfigureForNumbers (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,40);
...
_et = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.EditTextWrapper"), __ref.getField(false,"_textfield1" /*RemoteObject*/ ).getObject());Debug.locals.put("et", _et);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("GetPanel (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,116);
...
try {
		Debug.PushSubsStack("Initialize (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,16);
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_textfield1" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);
...
try {
		Debug.PushSubsStack("IsValid (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("SetBorder (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,99);
...
try {
		Debug.PushSubsStack("SetBorderColor (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,34);
...
try {
		Debug.PushSubsStack("Show (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,120);
...
_tf = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.EditTextWrapper"), __ref.getField(false,"_textfield1" /*RemoteObject*/ ).getObject());Debug.locals.put("tf", _tf);
...
try {
		Debug.PushSubsStack("TextField1_Action (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("TextField1_EnterPressed (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("TextField1_TextChanged (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("Validate (b4xinputtemplate) ","b4xinputtemplate",20,__ref.getField(false, "ba"),__ref,86);
