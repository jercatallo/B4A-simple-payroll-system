...
try {
		Debug.PushSubsStack("Base_Resize (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("Clear (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,120);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("getBitmap (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,131);
...
try {
		Debug.PushSubsStack("getCornersRadius (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("getResizeMode (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,68);
...
try {
		Debug.PushSubsStack("getRoundedImage (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("Initialize (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("Load (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,111);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 113;BA.debugLine="setBitmap(LoadBitmapSample(Dir, FileName, mBase.W";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("setBitmap (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("setCornersRadius (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("setResizeMode (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,72);
...
try {
		Debug.PushSubsStack("setRoundedImage (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("Update (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,78);
...
Debug.JustUpdateDeviceLine();
b4ximageview.__c.runVoidMethod ("LogImpl","918743323",RemoteObject.concat(RemoteObject.createImmutable("Invalid resize mode: "),__ref.getField(true,"_mresizemode" /*RemoteObject*/ )),0);
 break; }
}
;
...
try {
		Debug.PushSubsStack("UpdateClip (b4ximageview) ","b4ximageview",19,__ref.getField(false, "ba"),__ref,136);
...
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(true,"_mbackgroundcolor" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(true,"_mcornersradius" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 162;BA.debugLine="Dim jo As JavaObject = mBase";
Debug.JustUpdateDeviceLine();
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_mbase" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);
 BA.debugLineNum = 163;BA.debugLine="jo.RunMethod(\"setClipToOutline\", Array(mRound Or";
Debug.JustUpdateDeviceLine();
