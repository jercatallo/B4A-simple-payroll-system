...
try {
		Debug.PushSubsStack("Base_Resize (madewithlove) ","madewithlove",30,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("DesignerCreateView (madewithlove) ","madewithlove",30,__ref.getField(false, "ba"),__ref,15);
...
Debug.JustUpdateDeviceLine();
_cs.runMethod(false,"Initialize").runMethod(false,"Append",(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Made with ")))).runMethod(false,"Typeface",(Object)(madewithlove.__c.getField(false,"Typeface").runMethod(false,"getFONTAWESOME"))).runMethod(false,"Color",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Red"))).runMethod(false,"Append",(Object)(BA.ObjectToCharSequence(madewithlove.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xf004)))))).runMethod(false,"Pop").runMethod(false,"Pop").runMethod(false,"Append",(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable(" in B4X")))).runVoidMethod ("PopAll");
...
try {
		Debug.PushSubsStack("Initialize (madewithlove) ","madewithlove",30,__ref.getField(false, "ba"),__ref,9);
