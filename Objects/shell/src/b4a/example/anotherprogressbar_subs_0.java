...
try {
		Debug.PushSubsStack("Base_Resize (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("BusyLoop (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("DesignerCreateView (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("getValue (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,148);
...
try {
		Debug.PushSubsStack("getVisible (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,144);
...
try {
		Debug.PushSubsStack("Initialize (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("setValue (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,152);
...
try {
		Debug.PushSubsStack("SetValueNoAnimation (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,156);
...
try {
		Debug.PushSubsStack("setVisible (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,136);
...
try {
		Debug.PushSubsStack("UpdateGraphics (anotherprogressbar) ","anotherprogressbar",12,__ref.getField(false, "ba"),__ref,103);
