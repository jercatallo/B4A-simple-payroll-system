...
RDebugUtils.currentLine=26279937;
 //BA.debugLineNum = 26279937;BA.debugLine="mBase.GetView(0).SetLayoutAnimated(0, 0, 0, Wid";
...
RDebugUtils.currentLine=26214403;
 //BA.debugLineNum = 26214403;BA.debugLine="Dim xlbl As B4XView = Lbl";
_xlbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_xlbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
RDebugUtils.currentLine=26214418;
 //BA.debugLineNum = 26214418;BA.debugLine="Dim cs As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
RDebugUtils.currentLine=26214419;
 //BA.debugLineNum = 26214419;BA.debugLine="cs.Initialize.Append(\"Made with \").Typeface(Typef";
...
RDebugUtils.currentLine=26214420;
 //BA.debugLineNum = 26214420;BA.debugLine="xlbl.Text = cs";
_xlbl.setText(BA.ObjectToCharSequence(_cs.getObject()));
RDebugUtils.currentLine=26214421;
 //BA.debugLineNum = 26214421;BA.debugLine="xlbl.SetTextAlignment(\"CENTER\", \"CENTER\")";
_xlbl.SetTextAlignment("CENTER","CENTER");
RDebugUtils.currentLine=26214422;
 //BA.debugLineNum = 26214422;BA.debugLine="mBase.AddView(xlbl, 0, 0, mBase.Width, mBase.Heig";
